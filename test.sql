...
-- Change the Movie - Director relationship to "many-to-many"

-- what do we need to do?

-- films needs an id column! DONE

-- make a join table 'directors_films' that will capture the relationship once we are done remodeling DONE

-- fill in the combinations of director ids and film ids we have DONE

-- drop the director_id column from films, because that info is now in join table
