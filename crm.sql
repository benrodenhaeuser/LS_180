...
-- Interpretation: numbers are unique within the numbers column

ALTER TABLE contacts
ADD UNIQUE (number);

-- Attempt to insert duplicate number:

INSERT INTO contacts (first_name, last_name, number)
VALUES ('Tibor', 'Ramunari', '7204890809');
...
-- calls to contacts = many to 1
-- modality: on the contacts side: required (for a call, we need a contact)
-- on the calls side: not required: for a contact, we don't need a call 
